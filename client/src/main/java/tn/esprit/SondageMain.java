...
public class SondageMain {
	...
	public static void main(String[] args) throws NamingException {
		...
		//Question II.1.1
		QuestionSondage tvPrefere = new QuestionSondage("Quelle est votre cha�ne TV pr�f�r�e ?");
		...
		QuestionSondage fruitPrefere = new QuestionSondage("Quel est votre fruit pr�f�r� ?");
...
//		QuestionSondage couleurPrefere = new QuestionSondage("Quelle est votre couleur pr�f�r�e ?");
...
//		sondageServiceRemote.ajouterQuestionEtReponses(couleurPrefere);
		...
		//III.3.1
		//fetch
		System.out.println("Les r�ponses de Hela BOUAZIZ sont : ");
		...
		//III.3.2
		System.out.println("Nombre de personnes qui ont r�pondu : " + sondageServiceRemote.nbPersonne());
	}
